...
`, template.innerHTML.trim());
  ...
  var Webcam = class {
    constructor(webcamElement3, facingMode = "user", canvasElement3 = null, snapSoundElement3 = null) {
      this._webcamElement = webcamElement3;
      ...
      this._canvasElement = canvasElement3;
      this._snapSoundElement = snapSoundElement3;
    }
    get facingMode() {
    ...
    selectCamera() {
      for (let webcam3 of this._webcamList) {
        if (this._facingMode == "user" && webcam3.label.toLowerCase().includes("front") || this._facingMode == "enviroment" && webcam3.label.toLowerCase().includes("back")) {
          this._selectedDeviceId = webcam3.deviceId;
          break;
        }
      }
    }
  ...
  document.getElementById("capture").addEventListener("click", () => {
    ...
    const imageData = picture.replace(/^data:image\/(png|jpg);base64,/, "");
  ...
  // js/app.js
  var webcamElement2 = document.getElementById("webcam");
  var canvasElement2 = document.getElementById("canvas");
  var snapSoundElement2 = document.getElementById("snapSound");
  var webcam2 = new Webcam(webcamElement2, "user", canvasElement2, snapSoundElement2);
